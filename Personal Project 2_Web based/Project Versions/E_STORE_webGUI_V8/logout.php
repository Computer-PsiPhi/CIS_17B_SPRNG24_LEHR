...
if (isset($_COOKIE['login_time'])) {
    ...
    $total_time_readable = rawurlencode(timeElapsed($total_time)); // Convert the time to a readable format and URL encode it
}
...
header("Location: login.php?total_time={$total_time_readable}");
exit;
